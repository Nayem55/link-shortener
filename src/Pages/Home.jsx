...
const Home = () => {
  ...
  return (
    <>
      {/* ✅ React Helmet for Google SEO */}
      <Helmet>
        <title>Free URL Shortener | One-Click Link Shortening</title>
        <meta
          name="description"
          content="Shorten long URLs instantly with our free one-click URL shortener. The best alternative to Bitly and TinyURL."
        />
        <meta
          name="keywords"
          content="URL shortener, free link shortener, short links, bitly alternative, TinyURL alternative"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://shortlink.1clk.xyz/" />
      </Helmet>
      ...
      <div className="min-h-screen flex flex-col-reverse items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6">
        ...
        <div className="p-6 rounded-lg shadow-md w-full max-w-xl mt-8">
          ...
          <p className="text-white text-lg font-semibold text-center mb-4">
            ...
            free link shortener is the perfect alternative to Bitly, TinyURL,
          ...
          <p className="text-white text-lg font-semibold text-center">
            Generate short links for websites, social media, emails, SMS, and
            ads. Perfect for Instagram, LinkedIn, Facebook, X, TikTok, and
            beyond!
          </p>
        </div>
